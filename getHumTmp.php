...
$old_umask = umask(0);
if (!file_exists("$procPath/easyWebCharts")) mkdir("$procPath/easyWebCharts", 0777);
if (!file_exists("$procPath/easyWebCharts/archiv")) mkdir("$procPath/easyWebCharts/archiv", 0777);
...
if (!file_exists("$procPath/easyWebCharts/easyWebChart.jpg")) shell_exec("sudo ln -s /tmp/easyWebCharts/easyWebChart.jpg $procPath/easyWebCharts/easyWebChart.jpg");
umask($old_umask);
